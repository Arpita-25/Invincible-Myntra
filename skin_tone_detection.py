...
def extractSkin(image):
  ...
  image = cv2.imread("/content/try on.jpg")
  #image.show()
...
-----------------------------------------------------------
#CLOTH RECOMMENDATION MODEL
dom_list = dominantColors[0]['color']

dark_path = "/content/drive/MyDrive/dark_cloth"
dark_list = []
for root, dirs, files in os.walk(dark_path):
  dark_list += files

medium_path = "/content/drive/MyDrive/medium_cloth"
medium_list = []
for root, dirs, files in os.walk(medium_path):
  medium_list += files

light_path = "/content/drive/MyDrive/light_cloth"
light_list = []
