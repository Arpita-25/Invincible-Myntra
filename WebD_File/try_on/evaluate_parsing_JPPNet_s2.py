...
N_CLASSES = 20
INPUT_SIZE = (384, 384)
DATA_DIRECTORY = r'C:\Users\lenovo\Desktop\try_on\custom\test'
DATA_LIST_PATH = r'C:\Users\lenovo\Desktop\try_on\custom/test_pairs.txt'
NUM_STEPS = 1 # Number of images in the validation set.
RESTORE_FROM = r'C:\Users\lenovo\Desktop\try_on/checkpoint/JPPNet-s2'
OUTPUT_DIR = r'C:\Users\lenovo\Desktop\try_on/custom/test/image-parse'
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)
OUTPUT_DIR1 = r'C:\Users\lenovo\Desktop\try_on/custom/test/image-parse-new'
...
def main():
    ...
    for step in range(NUM_STEPS):
        ...
        cv2.imwrite('{}/{}.png'.format(OUTPUT_DIR1, img_id), parsing_[0,:,:,0])
