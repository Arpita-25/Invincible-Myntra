...
def get_opt():
    ...
    parser.add_argument("--dataroot", default=r"C:\Users\lenovo\Desktop\try_on\custom")
    ...
    parser.add_argument("--data_list", default="t-p.txt")
    ...
    parser.add_argument('--result_dir', type=str,
                        default=r'C:\Users\lenovo\Desktop\try_on\custom\test', help='save result infos')

    parser.add_argument('--checkpoint', type=str, default=r'C:\Users\lenovo\Desktop\try_on\CP-VTON+\checkpoints/TOM/tom_final.pth')
